...
class DonutsControllerTest < ActionController::TestCase
  ...
  test "should create donut" do
    assert_difference('Donut.count') do
      post :create, donut: { cost: @donut.cost, description: @donut.description, flavor: @donut.flavor, image: @donut.image }
    end
  ...
  test "should update donut" do
    patch :update, id: @donut, donut: { cost: @donut.cost, description: @donut.description, flavor: @donut.flavor, image: @donut.image }
    assert_redirected_to donut_path(assigns(:donut))
  end
